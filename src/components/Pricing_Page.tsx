          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <div className="ml-4 pl-4 border-l border-slate-200">
                <button className="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-sm transition-all active:scale-95">
                  Get Started
                </button>
              </div>
            </div>
          ...
          <div className="md:hidden bg-white border-b border-slate-200 animate-in slide-in-from-top duration-200">
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 px-4">
                <button className="w-full bg-red-600 text-white py-3 rounded-xl font-bold shadow-lg shadow-red-200">
                  Get Started Free
                </button>
              </div>
            </div>
